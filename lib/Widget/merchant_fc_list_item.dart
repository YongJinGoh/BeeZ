...
class MerchantFcListItem extends StatefulWidget {
  bool showAll = false;
  late MerchantModel data;

  MerchantFcListItem({required this.data});

  @override
  _MerchantFcListItemState createState() => _MerchantFcListItemState();
}

class _MerchantFcListItemState extends State<MerchantFcListItem> {
  @override
